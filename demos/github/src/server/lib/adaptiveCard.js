...
function getGithubIssueCard({ title, url, issuerName, issuerUrl, state, body, repoFullName, repoUrl, issueNumber, subscriptionId }) {
    const card = {
        "type": "AdaptiveCard",
        "body": [
            {
...
exports.getGithubIssueCard = getGithubIssueCard;